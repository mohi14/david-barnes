...
const ProjectDetails = () => {
    ...
    return (
        <div>
            <h1 className="sticky top-[150px] -z-20 text-[#000] uppercase lg:text-[160px] font-[700] leading-[120%] text-center lg:tracking-[-11.2px] projectDetailsTitle">{details.title}</h1>
