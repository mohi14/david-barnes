...
const InfoBanner = () => {
    return (
        <div className='info_banner'>
            ...
            <p className='text-3xl lg:text-[108px] font-bold mb-5'>Hey, this is <br /> David</p>
            ...
            <p className='text-3xl lg:text-[84px] font-semibold mb-[64px] flex justify-center'>Here’s what you can <br /> expect from me...</p>
        </div>
    );
};
